...
public class FPPB2 extends AppCompatActivity implements OnMapReadyCallback,GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks, AdapterView.OnItemSelectedListener {
    ...
    sqLite sq = new sqLite(FPPB2.this);
...
/*        toolbar.setTitle(Lokasi);*/
        ...
        ettgldikirim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(FPPB2.this,
...
//                    kendaraan2 = null;
    ...
    private void noConnection() {
        gerai = "201"; //201 = SIDOARJO, 202 = MALANG , 301 = BALI
...
/*            if (jikainternettersedia(this) == false) {
                Config.setLattitude(Float.parseFloat(null));
                Config.setLontitude(Float.parseFloat(null));
                //Toast.makeText(getApplicationContext(),"Tidak Ada Koneksi", Toast.LENGTH_SHORT).show();
            }else {
...
/*        Marker marker = mMap.addMarker(new MarkerOptions()
        ...
        txtTitle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(FPPB2.this,Cari.class);
...
//        toolbar.setTitle(Config.getLokasi());
    ...
    private void loadProvinsi() {
        ...
        ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<String>(FPPB2.this,android.R.layout.simple_spinner_item,spinnerProvList);
    ...
    private void loadKabupaten(int provId) {
        ...
        ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<String>(FPPB2.this,android.R.layout.simple_spinner_item,spinnerKabList);
        spinnerAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    private void loadKecamatan(int kabId) {
        ...
        ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<String>(FPPB2.this,android.R.layout.simple_spinner_item,spinnerKecList);
        spinnerAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    private void loadKelurahan(int kecId) {
        ...
        ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<String>(FPPB2.this,android.R.layout.simple_spinner_item,spinnerKelList);
        spinnerAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
...
//                        portal.isEmpty()
    ...
    private void runkirim() {
        ...
        RequestBody formBody = new FormBody.Builder()
                ...
                .add("nama", etnama.getText().toString().toUpperCase())
                .add("alamat", etalamat.getText().toString().toUpperCase())
                ...
                .add("penerima", etpenerima.getText().toString().toUpperCase())
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                FPPB2.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                    }
                });
                ...
                FPPB2.this.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (response.isSuccessful()) {
                            namatemp = etnama.getText().toString().toUpperCase();
                            tampilsnack("" + resp);
                        }
                    }
                });
...
//                    kendaraan2 = null;
                    ...
                    btnotemp.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            //sqlite = new sqLite(FPPB2.this);

                            sq = new sqLite(FPPB2.this);
                            sq.insertData(Str, tgl);
...
//                    Toast.makeText(this, "" + portal, Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        ...
        FancyAlertDialog.Builder alert = new FancyAlertDialog.Builder(FPPB2.this)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.riwa:
                Intent i = new Intent(FPPB2.this, riwayatfppb.class);
                i.putExtra("notemp", gerai);
            ...
            case R.id.cari:
                Intent a = new Intent(FPPB2.this, Cari.class);
                startActivity(a);
                /*finish();
                return true;*/
        }
